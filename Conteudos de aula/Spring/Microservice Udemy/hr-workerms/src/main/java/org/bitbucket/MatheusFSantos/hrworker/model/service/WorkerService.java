...
import org.bitbucket.MatheusFSantos.hrworker.model.validation.WorkerValidation;
...
public class WorkerService {
	...
	public Optional<Worker> findById(UUID id) throws WorkerExceptions {
		
		WorkerValidation.UUIDValidation(id);
	...
	public Worker save(Worker worker) throws WorkerExceptions {
		
		WorkerValidation.validationWithoutId(worker);
	...
	public void update(UUID id, Worker updatedWorker) throws WorkerExceptions {
		...
		WorkerValidation.UUIDValidation(id);
		WorkerValidation.validationWithoutId(updatedWorker);
